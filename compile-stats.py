...
# Feb19/2015 This script reads CSV files in a given folder and compiles the data in a single file. The input files are supposed to have 3 numeric columns 
# containing real numbers. The output file will contain all the original data and statistics about each individual file.  
#
# Usage: 
#  $ python ./compile-stats.py /home/acorreia/datafolder /home/acorreia/outputfolder outputfilename DRY AH
#
