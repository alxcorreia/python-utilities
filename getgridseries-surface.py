...
#
# Extracts time series at the surface from a .nc (netCDF) file at a single grid point
#
# Usage: 
# $ python ./getgridseries-surface.py /home/acorreia/datafolder/ncfile.nc outputfile
#
...
while (j<len(mylevel)):
    ...
    while (i < len(myvars)):        
        ...
        if ((myvars[i]!='longitude') and (myvars[i]!='latitude') and (myvars[i]!='time') ): 
            #print i,j
